    ...
    public partial class UserProfile : System.Web.UI.Page
    {
        ...
        void getUserBookData()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from booking_tbl where member_id='" + Session["username"].ToString() + "';", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                ...
                Label3.Text = dt.Rows[0]["status"].ToString().Trim();

                if (dt.Rows[0]["status"].ToString().Trim() == "Accepted")
                {
                    Label1.Attributes.Add("class", "badge badge-pill badge-success");
                }
                ...
                else if (dt.Rows[0]["status"].ToString().Trim() == "Rejected")
                {
                    Label3.Attributes.Add("class", "badge badge-pill badge-danger");
                }
                else if (dt.Rows[0]["status"].ToString().Trim() == "Task Completed")
                {
                    Label3.Attributes.Add("class", "badge badge-pill badge-light");
                }
                else
                {
                    Label3.Attributes.Add("class", "badge badge-pill badge-info");
                }
            }
            catch (Exception ex)
            {
